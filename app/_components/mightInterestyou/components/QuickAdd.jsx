...
export default function QuickAdd({ displayQuickAdd }) {
  return (
    <>
      ...
      >
        <div className="w-[50px] md:w-full flex justify-between items-center px-1 md:px-2 bg-white rounded-md">
          <img className="h-[12px]" src="/productpage/decreasesign.png"></img>
          <p>1</p>
          <img className="h-[12px]" src="/productpage/addsign.png"></img>
        </div>
        <button
          className={`text-[12px] md:text-[14px]  text-center bg-[#EE4197]  px-2 md:px-[12px] md:py-[9px] rounded-[4px] text-white leading-[21px] font-normal `}
        >
          Ajouter
        </button>
      </div>
