...
export default function SimilarSingleProduct(props) {
  ...
  return (
    <>
      <div
        ...
        className="w-[330px] gap-[12px] flex flex-col"
      >
        <div className="md:w-[330px] h-[250px]  md:px-2 md:h-[362px]  flex flex-col justify-between items-center bg-[#f9f7f5] rounded-md  ">
          <TopBarIcons />
          <img
            className={`h-[180px] w-[180px] px-2 md:h-[224px] md:w-[224px] mix-blend-multiply duration-300 ${
